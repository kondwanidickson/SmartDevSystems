...
export default function ImageDialog({payment, update}) {
  ...
  return (
    <div>
      ...
      <Dialog
        ...
        onClose={handleClose}
      >
        <DialogTitle color="primary">{"Verify Payment"}</DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          ...
          <Button 
            disabled={payment?._status === true ? true : false}
            onClick={(e)=>update(e, payment?.id,false)}
          >CANCEL</Button>
          <Button
            disabled={payment?._status === true ? true : false}
            onClick={(e)=>update(e, payment?.id,true)}
          >VERIFY</Button>
        </DialogActions>
      </Dialog>
    </div>
